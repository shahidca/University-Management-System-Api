...
export const sendVerificationEmail = async (
  ...
  const result =
    await mailTransporter.sendMail({
      ...
      to: email,
      subject:
        "UniCore Email Verification Code",
...
UniCore Team`,
  ...
  console.log(
    `Verification email accepted by SMTP for: ${email}`,
  );
...
UniCore Team`,
  ...
  console.log(
    `Password reset email accepted by SMTP for: ${email}`,
  );
