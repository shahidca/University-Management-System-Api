  ...
  z
    .object({
      name: z
        ...
        .max(
          50,
          "Academic year name must not exceed 50 characters",
        ),
...
export const academicYearListQuerySchema =
  z.object({
    page: z.coerce
      .number()
      .int()
...
export type AcademicYearListQueryInput =
  z.infer<
    typeof academicYearListQuerySchema
  >;