...
const recalculateInvoiceStatus = async (
...
export const reconcilePayment = async (
  ...
  const gateway =
    await querySSLCommerzTransaction(
...
return {
  ...
  invoice: invoiceStatus,
        ...
        if (
          ...
          throw new AppError(
            "A cancelled or failed payment cannot be reconciled as successful",
            409,
          );
        }
  ...
  return {
    ...
    invoice: {
      ...
      paidAmount:
        result.invoice.paidAmount.toString(),
      totalAmount:
