...
export const createProgramSchema = z.object({
  ...
  name: z
    ...
    .max(
      150,
      "Program name must not exceed 150 characters",
    ),
  ...
  code: z
    ...
    .min(
      2,
      "Program code must be at least 2 characters",
    )
    .max(
      30,
      "Program code must not exceed 30 characters",
    )
    .toUpperCase(),
...
export type ProgramListQueryInput =
  z.infer<typeof programListQuerySchema>;