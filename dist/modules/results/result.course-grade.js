...
export const calculateCourseGrade = (results) => {
    if (results.length === 0) {
        throw new AppError("No published exam results available", 404);
    }
    ...
    if (totalMarks <= 0) {
        throw new AppError("Course grade cannot be calculated because total marks are zero", 400);
    }
...
//# sourceMappingURL=result.course-grade.js.map