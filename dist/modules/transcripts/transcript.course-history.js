...
export const getStudentCourseHistory = async (userId) => {
    ...
    if (results.length === 0) {
        throw new AppError("No published course history available", 404);
    }
    return {
        student: {
            id: student.id,
        ...
        courses: results.map((result) => {
            ...
            return {
                ...
                section: {
                    code: result.enrollment.section
                        .sectionCode,
                },
                semester: {
                    id: semester.id,
...
//# sourceMappingURL=transcript.course-history.js.map