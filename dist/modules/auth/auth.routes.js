...
import { googleLoginController, } from "./auth.controller.js";
import { googleLoginSchema, } from "./auth.validation.js";
import { forgotPasswordController, getMe, login, logout, refresh, register, resendVerification, resetPasswordController, verifyEmail, } from "./auth.controller.js";
import { forgotPasswordSchema, loginSchema, logoutSchema, refreshTokenSchema, registerSchema, resendVerificationSchema, resetPasswordSchema, verifyEmailSchema, } from "./auth.validation.js";
const router = Router();
